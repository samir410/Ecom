...
<form action="{{route('product_update')}}" method="post" name="product_form">
@csrf
<div class="col-lg-6">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <textarea class="form-control" id="product_short_describtion" name="product_short_describtion">{{$product->product_short_describtion}}</textarea>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <textarea class="form-control" id="summary-ckeditor" name="product_long_describtion">{{$product->product_long_describtion}}</textarea>
...
<script>
   document.forms['product_form'].elements['catagory_id'].value = {{$product->catagory_id}};
</script>

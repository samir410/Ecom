        ...
        <div class="container">
            <div class="slider-active">
                <div class="slider-single-item">
                    <img src="{{asset('medicine/img/slider-img2.jpg')}}" class="img-fluid" alt="no image">
                ...
                <div class="slider-single-item">
                    <img src="{{asset('medicine/img/slider-img2.jpg')}}"  class="img-fluid" alt="">
                    <div class="slider-text">
                        <h2>Cherner <span>Armchair</span></h2>
                        <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
                        <a href="#">View now</a>
                ...
                <div class="slider-single-item">
                    <img src="{{asset('medicine/img/slider-img3.jpg')}}" class="img-fluid" alt="">
                    <div class="slider-text">
                        <h2>Cherner <span>Armchair</span></h2>
                        <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
                        <a href="#">View now</a>
				      ...
				      <!--Single product start-->
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#"> <img src="{{asset('medicine/img/product-img/product2.jpg')}}" alt=""></a>
                                            <a href="#"> <img class="secondary-img" src="{{asset('medicine/img/product-img/product1.jpg')}}"
                                                    alt=""></a>
                                            <span>hot</span>
                    ...
                    <div class="product-tab">
                        ...
                        <div class="tab-content">
                           ...
                           ')}}         </div>
                                    ...
                                    <!----  Single product End-->{{asset('medicine/
                           ')}}         <!----  Single product start-->
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#"> <img src="{{asset('medicine/img/product-img/product2.jpg')}}" alt=""></a>
    ...
    <div class="banner-area pb-5">
        <div class="container">
            <div class="banner-img">
                <a href="#"><img class="img-fluid" src="{{asset('medicine/img/banner-img/banner.jpg" a')}}lt=""></a>
            </div>
        </div>
    </div>
    <!--Product Area-->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="furniture1" role="tabpanel" aria-labelledby="l1">
                                <div class="product-active owl-carousel nav-style">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#"> <img src="{{asset('medicine/img/product-img/product1.jpg')}}" alt=""></a>
                                            <a href="#"> <img class="secondary-img" src="{{asset('medicine/img/product-img/product2.jpg')}}"
                                                    alt=""></a>
                                            <div class="product-action">
                                                <a href="#"><i class="far fa-eye"></i></a>
                                                <a href="#"><i class="fas fa-balance-scale"></i></a>
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#"> <img src="{{asset('medicine/img/product-img/product3.jpg')}}" alt=""></a>
                                            <a href="#"> <img class="secondary-img" src="{{asset('medicine/img/product-img/product2.jpg')}}"
                                                    alt=""></a>
                                            <div class="product-action">
                                                <a href="#"><i class="far fa-eye"></i></a>
        ...
        <div class="container ">
            <div class="row">
                <div class="brand-active owl-carousel ">
                    <div class="single-brand"><a href=""><img src="{{asset('medicine/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('medicine/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('medicine/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('medicine/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('medicine/img/brand/brand1.jpg')}}" alt="" class=""></a></div>

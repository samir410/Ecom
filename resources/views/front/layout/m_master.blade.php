...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('medicine/css/bootstrap.min.css')}}">
    <!-- MAIN CSS-->
    <link rel="stylesheet" href="{{asset('medicine/css/main.css')}}">
    <!--my responsive-->
    <link rel="stylesheet" href="{{asset('medicine/css/responsive.css')}}">
    <!--- FONT AWESOME -->
    <link rel="stylesheet" type="text/css" href="{{asset('medicine/css/all.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('medicine/css/meanmenu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('medicine/css/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('medicine/css/slick-theme.css')}}">
    <link rel="stylesheet" href="{{asset('medicine/css/nice-select.css')}}">
    <!--- awl carousel -->
    <link rel="stylesheet" type="text/css" href="{{asset('medicine/css/owl.carousel.min.css')}}">
...
<body>
        ...
        <div class="container position-relative">
            <div class="row">
                ...
                <div class="col-xl-2 col-md-4 col-sm-12 text-center mb-0  my-xl-5 ">
                    <div class="">
                        <a href="index.html" class="text-center"><img width="175" height="45" src="{{asset('medicine/img/logo.png')}}"
                                alt=""></a>
                    </div>
                </div>
  ...
  @yield('content_m')
   ...
   <!--Footer-sectionzz-->
    ...
    <script src="{{asset('medicine/js/jquery-3.4.1.min.js')}}"></script>
    <script src="{{asset('medicine/js/popper.min.js')}}"></script>
    <script src="{{asset('medicine/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('medicine/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('medicine/js/jquery.meanmenu.min.js')}}"></script>
    <script src="{{asset('medicine/js/slick.min.js')}}"></script>
    <script src="{{asset('medicine/js/jquery.nice-select.min.js')}}"></script>

    <!-- My Js-->
    <script src="{{asset('medicine/js/main.js')}}"></script>
</body>
